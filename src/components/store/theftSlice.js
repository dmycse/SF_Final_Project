...
export let status = [
	{key: 'Выберите cтатус', value: ''},
	{key: 'новое', value: 'new'},
	{key: 'в работе', value: 'in_progress'},
	{key: 'завершено', value: 'done'},
];

export let bikeType = [
	{key: 'Выберите тип', value: ''},
	{key: 'простой', value: 'general'},
	{key: 'спортивный', value: 'sport'},
];

export let bikeColor = [
	{key: 'Выберите цвет', value: ''},
	{key: 'красный', value: 'red'},
	{key: 'синий', value: 'blue'},
	{key: 'зелёный', value: 'green'},
];
...
export let fetchAddTheftCase = createAsyncThunk(
	...
	async function (values, {rejectWithValue, dispatch}) {
		...
		try {
			...
			// console.log('fetchAddTheftCase', addNewTheftCase);
...
export let fetchNewTheftCase = createAsyncThunk(
	...
	async function (values, {rejectWithValue, dispatch}) {
		...
		try {
			...
			// console.log('fetchNewTheftCase', newTheftCase);
...
export let fetchChangeTheftCase = createAsyncThunk(
	...
	async function (values, {rejectWithValue, dispatch}) {
		...
		try {
			...
			// console.log('fetchChangeTheftCase', updatedData);
